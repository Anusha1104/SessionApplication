<%@ Page Title="" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="SessionApplication.WebForm1" %>
...
<table style="align-items:center" left="25%" class="auto-style10">
        ...
        <tr>
            <td>
                <asp:Button ID="Button2" BackColor="GreenYellow" runat="server" Text="Save & exit" OnClick="Button2_Click" CausesValidation="False" />
                <br />
                <br />
                <br />
                <br />
